# Orientações - Prova Recuperação [02/09/2022 - 13:00 até 15:20]
...
```html
https://github.com/ldmfabio/1INFO1_if-else_provaRec.git
```
*Ou então*, no terminal do VSCode, digite:
```GIT
git clone https://github.com/ldmfabio/1INFO1_if-else_provaRec.git
```
